  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="bg-gray-900 h-1/5 flex flex-wrap">
        <div className="bg-yellow-300 w-1/4 p-4">Card 1</div>
        <div className="bg-red-300 w-1/4 p-4">Card 2</div>
      ...
      <div className="bg-green-400 flex-1">
        <div className="flex w-full h-full">
          <div className="w-1/2 bg-green-300">
            <div className="flex justify-center">
              ...
              />
                ...
                <button
                  type="button"
                  className="m-3 w-1/6 bg-purple-500 text-white py-2 rounded-md"
            ...
            <div className="flex w-full justify-center">
              <div className="container-fliud bg-green-400 w-1/2">
                <div className="bg-black flex justify-around rounded-full m-2">
                  <div className="m-2 w-2/3 ">
                    <label htmlFor="upper" className="text-yellow-300">
                      Uppercase
                    </label>
                  </div>
                  <div className="m-2">
                ...
                <div className="bg-black flex justify-around rounded-full m-2">
                  <div className="m-2 w-2/3">
                    <label htmlFor="lower" className="text-yellow-300">
                      Lowercase
                    </label>
                  </div>
                  <div className="m-2">
                ...
                <div className="bg-black flex justify-around rounded-full m-2">
                  <div className="m-2 w-2/3">
                    <label htmlFor="special" className="text-yellow-300">
                      Special Characters
                    </label>
                  </div>
                  <div className="m-2">
                ...
                <div className="bg-black flex justify-around rounded-full m-2">
                  <div className="m-2 w-2/3">
                    <label htmlFor="numbers" className="text-yellow-300">
                      Numbers
                    </label>
                  </div>
                  <div className="m-2">
                ...
                <div className="bg-black flex justify-around rounded-full m-2">
                  <div className="m-2 w-2/3">
                    <label htmlFor="passwordLength" className="text-yellow-300">
                      Password Length
                    </label>
                  </div>
                  <div className="m-2">
                    <select
                      ...
                      className="py-1 px-2 rounded-md bg-gray-300"
                    >
          ...
          <div className="w-1/2 bg-blue-200">List</div>
        </div>
      </div>
    </div>
  );
